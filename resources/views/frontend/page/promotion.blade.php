...
<body>
    ...
    <div class="content-page">
        <div class="container">
            ...
            <div class="all-content-page-promotion mt-5">
                <div class="promotion-blog-page">
                    <div class="detail-of-winner">
                        <div class="title-detail-of-winner">
                            <p>ពត៏មានអំពីរង្វាន់</p>
                        </div>
                        <div class="blog-detail-winnder-list">
                            <div class="content-box-winner">
                                <div class="winner-box">
                                    <div class="image-winder">
                                        <img src="{{ asset('image/winnder.png') }}">

                                    </div>
                                    <div class="text-and-condition-winner">
                                        <p>Honda CB 150cc 2020</p>
                                        <p class="text-danger" style="margin-top: -10px"><b>Claim Point: 4,235,000</b>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="winner-box">
                                    <div class="image-winder">
                                        <img src="{{ asset('image/samsong.png') }}">

                                    </div>
                                    <div class="text-and-condition-winner">
                                        <p>Samsong Galaxy A14 5G</p>
                                        <p class="text-danger" style="margin-top: -10px"><b>Claim Point: 4,235,000</b>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="winner-box">
                                    <div class="image-winder">
                                        <img src="{{ asset('image/Vivo S1.png') }}">
                                ...
                                <div class="winner-box">
                                    <div class="image-winder">
                                        <img src="{{ asset('image/Oppo Reno 2F.png') }}">
                                    </div>
                                    <div class="text-and-condition-winner">
                                        <p>Nokia 105 (Cambodia Only)</p>
                                        <p class="text-danger" style="margin-top: -10px"><b>Claim Point: 4,235,000</b>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="winner-box">
                                    <div class="image-winder">
                                        <img src="{{ asset('image/samsong A 12.png') }}">
