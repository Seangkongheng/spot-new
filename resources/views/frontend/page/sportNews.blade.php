    ...
    <div class="content-page">
        <div class="container">
            ...
            <div class="all-content-page">
                ...
                {{-- sport-new --}}
                <section id="sportNews">
                    <div class="sport-news mt-5">
                        <div class="sport-content">
                            <div class="top-sport-content">
                                <div class="top-sport-content-action">
                                    ...
                                    {{-- <div class="block-readmore-top-sport">
                                        <a href="">អានបន្ថែម&nbsp;&nbsp;<i class="fa-solid fa-arrow-right"></i></a>
                                    </div> --}}
                                </div>
                            </div>
                            ...
                            <div class="all-block-sport-news-content">

                                @foreach ($atticle as $item)
                                    <div class="content-spot-image-sport-Newspage">
                                        <div class="sport-image-pageNews">
                                            <a href="{{ route('showPostView', [$item->id]) }}">
                                                <div class="image-content-sport-pageNews">
                                                    <img src="{{ asset('upload/image/' . $item->image) }}"
                                                        alt="Your Image">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="sport-decription-pageNews">
                                            <div class="decription-sport-pagenew">
                                                {{-- thumnail title --}}
                                                <h1><b>{{ $item->Title }}</b></h1>
                                                <p class="mt-3">{{ $item->Subtitle }}</p>
                                                {{-- date-readmore --}}
                                                <div class="status">
                                                    <div class="content-date-readmore-pageNews">
                                                        <div class="date">
                                                            <b>Date :</b> <i>{{ $item->created_at }}</i>
                                                        </div>
                                                        <div class="read-more">
                                                            {{-- <a class="btn btn-warning" href="{{ route('showPost', [$item->id]) }}">Show</a> --}}
                            ...
                            <div style="margin-left: 500px;" class="text-center mt-5">
                                {{ $atticle->onEachSide(1)->links() }}
                            </div>
                        </div>
                    </div>
            </div>
