    ...
    <div class="content-page">
        <div class="container">
            <div class="content-for-join-name">
                {{-- join name --}}
                <div class="all-content-for-join-name-box">
                    <div class="box-join-name">
                ...
                {{-- button join name --}}
                <div class="all-buttion-join-name-page-sport-new mt-5">
                    <div class="row">
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            <a class="text-decoration-none" href=""
                                style="padding: 20px 110px;font-size: 30px; color:white; background: linear-gradient(90deg, rgba(159,28,33,1) 0%, rgba(255,0,0,1) 49%, rgba(161,69,94,1) 100%);border-radius:20px ;">
                                <i class="fa-solid fa-file-invoice-dollar"></i>&nbsp;ដក់ប្រាក់</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="all-content-page mt-5">
